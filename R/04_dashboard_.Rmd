...
# Set working directory to script location for reproducibility
if (interactive()) {
  # When running interactively, set to the project root
...
if (data_available) {
  ...
  cat("\n========================================\n")
  cat("LQAS Dashboard Data Load Summary\n")
  cat("========================================\n")
  cat("Data file:", params$data_file, "\n")
  ...
  cat("Global metrics calculated:\n")
  cat("  - Total districts:", global_metrics$total_districts, "\n")
  cat("  - Mean coverage:", global_metrics$mean_coverage, "%\n")
  cat("  - Pass rate:", global_metrics$pass_rate, "%\n")
  cat("========================================\n\n")
}
